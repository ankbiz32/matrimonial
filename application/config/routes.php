...
$route['submit-register'] = 'UserLogin/submitRegister';
$route['change-password'] = 'UserLogin/changePwd';
$route['update-profile'] = 'Home/updateProfile';
$route['subscribe'] = 'Home/Subscribe';
$route['submit-login'] = 'UserLogin/authenticate';
